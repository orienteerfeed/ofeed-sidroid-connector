...
extensions.configure<ApplicationExtension> {
    ...
    defaultConfig {
        ...
        minSdk = 23
        targetSdk = 36
        versionCode = 23     // 23/1.0.1=Production. 22=Web link. 21=Event name/image. 20=Czech. 19=Help scan/paste. 18=Settings layout. 17=Credentials help. 16=Settings updates. 15=Clear OFeed error message. 14=App link/share/paste. 13=Check for nothing to upload. 12=Remove incomplete persons. 11=Czech. 10=OResults. Upload of local file.
        versionName = "1.0.1"
    }
